            ...
            <div className="row-span-1">
                ...
                <div className="row-span-2 text-left p-2">
                    <div className="my-2 flex items-start p-1">
                        ...
                        <p >Bring all your data on a no-code powerful platform to maximize the efficacy of AML compliance operations</p>
                    </div>
                    <div className="my-2 flex items-start p-1">
                        <div className="bg-blue-500 rounded-full w-5 h-5 flex items-center justify-center mr-2">
                        ...
                        <p>Combine screening with transaction monitoring, customer risk, assessment and more</p>
                    </div>
