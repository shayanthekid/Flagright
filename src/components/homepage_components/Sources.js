    ...
    return (
        <div className="grid grid-rows-2 bg-neutral-50  ">
            <div className="row-span-2">
                <h1 className="font-sans font-bold text-left text-3xl mx-10 mb-5 ">Reliable, global data sources</h1>
            </div>
            ...
            <div className="row-span-2 grid grid-cols-2 justify-center items-center  ">
                <img src={logo1} className=" w-20 h-20 object-fit my-2 mx-auto" alt="image1" />
                <img src={logo4} className="object-fit  w-20 h-20 my-2 mx-auto" alt="image2" />
                <img src={logo2} className="object-fit w-20 h-20 my-2 mx-auto" alt="image2" />
                <img src={logo3} className="object-fit  w-20 h-20 my-2 mx-auto " alt="image2" />
            </div>
        </div>
    )
  }
